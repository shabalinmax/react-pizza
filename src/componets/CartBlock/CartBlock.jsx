        ...
        <div className="cart">
            <div className="cart__top">
                ...
                <div className="cart__clear">
                    ...
                    <span onClick={deleteAllCart}>Очистить корзину</span>
                </div>
            </div>
                    ...
                    cartItems.map(item =>
                        <div key={item.id} className="cart__item">
                            ...
                            <div className="cart__item-info">
                                <h3>{item.title}</h3>
                                <p>{item.activeType === 0 ? `тонкое тесто` : `толстое тесто`}, {item.activeSize + ' см'}</p>
                            </div>
            ...
            <div className="cart__bottom">
                <div className="cart__bottom-details">
                    <span onClick={alert}> Всего пицц: <b>{cartItems.length + ' шт.'}</b> </span>
                    <span> Сумма заказа: <b>{totalSumOfCart + ' руб.'}</b> </span>
                </div>
